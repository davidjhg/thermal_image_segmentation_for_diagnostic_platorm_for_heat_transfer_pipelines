...
class FuseNet(nn.Module):
    def __init__(self, num_labels=1, gpu_device=0, use_class=False):
        ...
        # DEPTH ENCODER
        self.conv11d = nn.Conv2d(3, 64, kernel_size=3, padding=1).cuda(gpu_device)
        self.conv11d.weight.data = feats[0].cuda(gpu_device).weight.data
